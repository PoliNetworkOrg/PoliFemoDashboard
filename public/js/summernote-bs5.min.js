      ...
      (() => {
        ...
        const f = {
          ...
          isFontInstalled: function (t) {
            ...
            function i(t) {
              return (
                o.clearRect(0, 0, 40, 20),
                (o.font = "20px " + r(t) + ', "' + e + '"'),
                o.fillText("mw", 20, 10),
                o.getImageData(0, 0, 40, 20).data.join("")
              );
            }
            return (
              (n.width = 40),
        ...
        var N = x("TABLE"),
          R = x("DATA");
        function P(t) {
          return !(H(t) || A(t) || L(t) || E(t) || N(t) || D(t) || R(t));
        }
        function A(t) {
        ...
        function st(t, e, n) {
          ...
          if (1 === o.length) return at(e, n);
          if (o.length > 2) {
            var i = o.slice(0, o.length - 1).find(function (t) {
            ...
            if (i && 0 != e.offset && Y(e)) {
              var r,
                a = i.nextSibling;
              1 == a.nodeType
                ? ((o = K((r = a.childNodes[0]), v.eq(t))),
                  (e = { node: r, offset: 0 }))
                : 3 != a.nodeType ||
                  a.data.match(/[\n\r]/g) ||
                  ((o = K((r = a), v.eq(t))), (e = { node: r, offset: 0 }));
            }
          }
            ...
            (o = [
              {
                ...
                value: function () {
                  ...
                  var e = bt({ node: this.sc, offset: this.so });
                  return (
                    e.setEndPoint(
                      "EndToEnd",
                      bt({ node: this.ec, offset: this.eo })
                    ),
                    e
                  );
                },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var o = ht.splitPoint(n.getStartPoint(), ht.isInline(t));
                  return (
                    o.rightNode
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    (o = o.map(function (t) {
                      return i.insertNode(t, !ht.isInline(t));
                    })),
                    r && (o = o.reverse()),
                    o
                  );
        ...
        const Ct = {
          isEdit: function (t) {
            return k.contains(
              [wt.BACKSPACE, wt.TAB, wt.ENTER, wt.SPACE, wt.DELETE],
              t
            );
          },
          isRemove: function (t) {
            return k.contains([wt.BACKSPACE, wt.DELETE], t);
          },
          isMove: function (t) {
            return k.contains([wt.LEFT, wt.UP, wt.RIGHT, wt.DOWN], t);
          },
          isNavigation: function (t) {
            return k.contains([wt.HOME, wt.END, wt.PAGEUP, wt.PAGEDOWN], t);
          },
          nameFromCode: v.invertObject(wt),
          code: wt,
        };
        function xt(t, e) {
          for (var n = 0; n < e.length; n++) {
              ...
              },
              {
                ...
                value: function (t) {
                  null !== t.contents && this.$editable.html(t.contents),
                    null !== t.bookmark &&
                      kt.createFromBookmark(this.editable, t.bookmark).select();
                },
              },
              {
                key: "rewind",
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  var n = this,
                    o = kt.create(t).wrapBodyInlineWithPara(),
              ...
              },
              {
                ...
                value: function (t, n) {
                  var o = this,
                    i = kt.create(n).wrapBodyInlineWithPara(),
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t, n) {
                  n = (n = (n =
                    n ||
                    kt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                  var o,
                  ...
                  kt.create(o, 0).normalize().select().scrollIntoView(t);
                },
              },
            ]),
            o && Nt(n.prototype, o),
        ...
        var Dt = (function () {
          function t(n) {
            ...
            !(function (t, e) {
              ...
              (this.style = new Et()),
              (this.table = new Lt()),
              (this.typing = new Rt(n)),
              (this.bullet = new $t()),
              (this.history = new St(n)),
            ...
            (this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.pasteHTML = this.wrapCommand(function (t) {
                if (!o.isLimited(t.length)) {
                  ...
                  o.setLastRange(kt.createFromNodeAfter(k.last(e)).select());
                }
              })),
              ...
              (this.insertHorizontalRule = this.wrapCommand(function () {
                ...
                t.nextSibling &&
                  o.setLastRange(
                    kt.create(t.nextSibling, 0).normalize().select()
                  );
              })),
              ...
              (this.createLink = this.wrapCommand(function (t) {
                var n = [],
                  ...
                  a = t.isNewWindow,
                  s = t.checkProtocol,
                  l = o.options.linkAddNoReferrer,
                  c = o.options.linkAddNoOpener,
                  u = t.range || o.getLastRange(),
                  d = r.length - u.toString().length;
                if (!(d > 0 && o.isLimited(d))) {
                  var h = u.toString() !== r;
                  "string" == typeof i && (i = i.trim()),
                    o.options.onCreateLink
                      ? (i = o.options.onCreateLink(i))
                      : s &&
                        (i = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(i)
                          ? i
                          : o.options.defaultProtocol + i);
                  var f = [];
                  if (h) {
                    var p = (u = u.deleteContents()).insertNode(
                      e()("<A>" + r + "</A>")[0]
                    );
                    f.push(p);
                  } else
                    f = o.style.styleNodes(u, {
                      nodeName: "A",
                      expandClosestSibling: !0,
                      onlyPartialContains: !0,
                    });
                  e().each(f, function (t, o) {
                    e()(o).attr("href", i),
                      a
                        ? (e()(o).attr("target", "_blank"),
                          l && n.push("noreferrer"),
                          c && n.push("noopener"),
                          n.length && e()(o).attr("rel", n.join(" ")))
          ...
          return (
            ...
            (o = [
                  ...
                  return (
                    ...
                    (void 0 === e ||
                      !(
                        ...
                        e.metaKey ||
                        k.contains(
                          [Ct.code.BACKSPACE, Ct.code.DELETE],
                          e.keyCode
                        )
                      )) &&
              ...
              },
              {
                ...
                value: function (t) {
                  var e = kt.createFromNodeBefore(k.head(t)).getStartPoint(),
                    n = kt.createFromNodeAfter(k.last(t)).getEndPoint();
                    ...
                    : ((this.lastRange = kt.create(this.editable)),
                      0 ===
                        e()(this.lastRange.sc).closest(".note-editable")
                          .length &&
                        (this.lastRange = kt.createFromBodyElement(
                          this.editable
                        )));
                },
              },
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  (t = kt.create()).isCollapsed() &&
                    ...
                    ("P" === n
                      ? e.remove()
                      : ["TH", "TD"].indexOf(n) >= 0 && e.firstChild.remove());
                },
              },
              {
                key: "insertImage",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    t.isOnAnchor() &&
                      (t = kt.createFromNode(ht.ancestor(t.sc, ht.isAnchor))),
                    t.toString()
                  );
                },
              },
                ...
                value: function (t, n) {
                  ...
                  if ((this.context.invoke("imagePopover.update", t, n), o)) {
                    ...
                    var c =
                      ...
                      l.height +
                      ")";
                    i.find(".note-control-selection-info").text(c),
            ...
            return (
              ...
              (o = [
                ...
                },
                {
                  key: "handleKeyup",
                  value: function (t) {
                    (Ct.code.SPACE === event.keyCode ||
                      (Ct.code.ENTER === event.keyCode && !event.shiftKey)) &&
                      this.replace();
                  },
                },
              ]) && Zt(n.prototype, o),
        ...
        var ae = (function () {
          function t(n) {
            !(function (t, e) {
              ...
              (this.options = n.options),
              (this.lang = this.options.langInfo),
              (this.invertedKeyMap = v.invertObject(
                ...
                value: function () {
                  ...
                  var o = this.options.dialogsInBody
                    ...
                    i = [
                      ...
                      "<p>Puoi caricare un immagine dal tuo computer caricandola su un servizio esterno come <a href='https://m.imgur.com/upload' target='_blank'>Imgur</a> e incollando l'URL qui sotto.</p>",
            ...
            (o = [
              {
                ...
                value: function () {
                  var t = this.options.dialogsInBody
                    ...
                    e = [
                      '<p class="text-center">',
                      '<a href="http://summernote.org/" target="_blank" rel="noopener noreferrer">Summernote 0.8.19</a> · ',
          ...
          function t(n) {
            ...
            !(function (t, e) {
              ...
              (this.events = {
                ...
                "summernote.mousedown": function (t, e) {
                  (o.pageX = event.pageX), (o.pageY = event.pageY);
                },
                    ...
                    if (o.options.editing && !o.onContextmenu) {
                      if ("keyup" == e.type) {
                        var n = o.context
                            ...
                            .getWordRange(),
                          i = v.rect2bnd(k.last(n.getClientRects()));
            ...
            (o = [
                ...
                value: function () {
                  ...
                  if (t.length) {
                    ...
                    if (
                      ...
                      e()(n).after(i), kt.createFromNodeBefore(i).select();
                    } else kt.createFromNodeAfter(n).select();
                    (this.lastWordRange = null),
                      this.hide(),
                      this.context.invoke("editor.focus"),
                      this.context.triggerEvent(
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  return n.map(function (n, i) {
                    var r = e()('<div class="note-hint-item"></div>');
                    return (
                      r.append(o.template ? o.template(n) : n + ""),
                      r.data({ index: t, item: n }),
                      0 === t && 0 === i && r.addClass("active"),
                      r
                    );
                  });
                },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    !k.contains(
                      [Ct.code.ENTER, Ct.code.UP, Ct.code.DOWN],
                      t.keyCode
                    )
                  ) {
                    var o,
        ...
        const Re = function (t, e) {
          return function () {
            var n = "object" === Ie(arguments[1]) ? arguments[1] : arguments[0],
              o = Array.isArray(arguments[0]) ? arguments[0] : [];
            return n && n.children && (o = n.children), new Ne(t, o, n, e);
          };
        };
        function Pe(t) {
          return (
        ...
        var Ae = Re('<div class="note-editor note-frame card"/>'),
          Le = Re('<div class="note-toolbar card-header" role="toolbar"/>'),
          Fe = Re('<div class="note-editing-area"/>'),
          De = Re('<textarea class="note-codable" aria-multiline="true"/>'),
          He = Re(
          ...
          ze = Re('<div class="note-editor note-airframe"/>'),
          Me = Re(
            [
          ...
          Oe = Re('<div class="note-btn-group btn-group">'),
          Ue = Re(
          ...
          qe = Re(
            ...
            function (t, e) {
              ...
              t.attr("data-popper-placement", n),
                e.hideArrow && t.find(".popover-arrow").hide();
            }
          ),
          Ve = Re('<div class="form-check"></div>', function (t, e) {
            t.html(
              [
          ...
          ui_template: function (t) {
            return {
              ...
              palette: function (e, n) {
                return Re('<div class="note-color-palette"/>', function (e, n) {
                ...
                return Re(
                  ...
                  function (n, o) {
                    o && o.data && "dropdown" === o.data.toggle
                      ? (n.removeAttr("data-toggle"),
                        n.attr("data-bs-toggle", "dropdown"),
                        o &&
                          o.tooltip &&
                          n.attr({ title: o.tooltip, "aria-label": o.tooltip }))
                      : o &&
                        o.tooltip &&
                        n
